...
git add README.md docs .gitignore dab_mlops_stack/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-284164925765829.9.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-5648742786543115.15.azuredatabricks.net#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[dab_mlops_stack/databricks.yml](../dab_mlops_stack/databricks.yml) file. 
...
Follow the instructions in [dab_mlops_stack/resources/README.md](../dab_mlops_stack/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../dab_mlops_stack/resources/README.md)  to propose, test, and deploy
