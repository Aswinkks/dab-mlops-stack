...
Opening a pull request will trigger a[workflow](../.github/workflows/dab_mlops_stack-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-284164925765829.9.azuredatabricks.net/ml/models/staging-dab_mlops_stack-model)
* [Prod workspace registered model](https://adb-5648742786543115.15.azuredatabricks.net/ml/models/prod-dab_mlops_stack-model). 
